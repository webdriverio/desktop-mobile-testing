...
- [WDIO Electron CDP Bridge](#wdio-electron-cdp-bridge)
...
```bash
# Using npm
npm install @wdio/electron-cdp-bridge

# Using yarn
yarn add @wdio/electron-cdp-bridge

# Using pnpm
pnpm add @wdio/electron-cdp-bridge
```
...
```ts
import { DevTool } from '@wdio/electron-cdp-bridge';

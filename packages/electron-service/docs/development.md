...
Author: mato533
URL: https://github.com/webdriverio/desktop-mobile/pull/904
--------------------------------------------------------------------------------
...
Author: mato533
URL: https://github.com/webdriverio/desktop-mobile/pull/908
--------------------------------------------------------------------------------
✔ Do you want to backport this PR? Yes, I want to backport this PR.
...
2. Create a patch release using the [release workflow](https://github.com/webdriverio/desktop-mobile/actions/workflows/release.yml):
